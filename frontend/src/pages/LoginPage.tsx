...
export default function LoginPage() {
  ...
  }, [email, password, login, navigate, toast, t]);
    ...
    <div className="min-h-screen bg-gray-950 flex flex-col items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-semibold text-white">{t('auth.login')}</h1>
        </div>
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-md p-6 space-y-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-2.5 bg-gray-700 hover:bg-gray-600 disabled:opacity-50 text-white rounded-lg font-semibold text-sm transition-colors"
            >
