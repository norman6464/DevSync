  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        {tab !== 'level' && <div className="ml-auto flex bg-gray-900 border border-gray-800 rounded-lg p-1">
          <button
      ...
      {loading ? (
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-md overflow-hidden">
          <div className="px-6 py-3 border-b border-gray-800 grid grid-cols-[3rem_1fr_auto] gap-4 text-xs font-medium text-gray-500 uppercase tracking-wider">
            ...
            <span className="text-right">{tab === 'contributions' ? t('rankings.contributions') : tab === 'level' ? t('level.xpUnit') : t('rankings.total')}</span>
          </div>
