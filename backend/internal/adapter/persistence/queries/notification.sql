...
SELECT
    ...
    (SELECT COUNT(*) FROM likes WHERE likes.post_id = posts.id) AS post_like_count,
    ...
    (SELECT COUNT(*) FROM post_views WHERE post_views.post_id = posts.id) AS post_view_count,
