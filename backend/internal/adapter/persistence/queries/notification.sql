...
SELECT
    ...
    (SELECT COUNT(*) FROM post_reactions WHERE post_reactions.post_id = posts.id AND post_reactions.kind = 'like') AS post_like_count,
    (SELECT COUNT(*) FROM comments WHERE comments.post_id = posts.id) AS post_comment_count,
    (SELECT COUNT(*) FROM post_reactions WHERE post_reactions.post_id = posts.id AND post_reactions.kind = 'bookmark') AS post_bookmark_count,
    (SELECT COUNT(*) FROM post_reactions WHERE post_reactions.post_id = posts.id AND post_reactions.kind = 'view') AS post_view_count,
